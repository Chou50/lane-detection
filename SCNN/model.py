...
"""
Because Carla data is used here, there are some modifications for model.
1. Output channel of seg_pred is changed to 3.
2. Exist_pred is deleted, because there is no exist label.
3. Loss function of model is re-writen in lossfunction.py.
"""
...
class SCNN(nn.Module):
    ...
    def forward(self, img):
        ...
        x = self.layer2(x)     # Here output channel is changed to be 3, because carla data is used here
    ...
    def net_init(self, input_size, ms_ks):
        ...
        self.layer2 = nn.Sequential(
            nn.Dropout2d(0.1),
            nn.Conv2d(128, 3, 1)
        )   # Here output channel is changed to be 3, because carla data is used here
