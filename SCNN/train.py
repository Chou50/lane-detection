...
from lossfunction import calc_loss, print_metrics
...
Update the best model when validating loss is smaller than the best loss.
"""
...
def train_model(dataloaders, model, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        # There is a training and validating step, respectively, in each epoch
